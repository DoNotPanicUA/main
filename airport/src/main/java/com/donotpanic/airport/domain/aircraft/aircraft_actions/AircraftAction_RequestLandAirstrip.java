...
public class AircraftAction_RequestLandAirstrip extends AircraftAction implements Runnable{
    ...
    protected boolean checkPreCondition(Plane plane) {
        return (plane.getReservedAirstrip() == null &&
                Actions.RADIOTOWER_REQUEST.getDurationSec()*2.5*plane.getSpeed() >= GeoLocationService.calculateDistance(plane.getDestinationTo(), getEngine().getObjectCoordinates(plane)));
    }
