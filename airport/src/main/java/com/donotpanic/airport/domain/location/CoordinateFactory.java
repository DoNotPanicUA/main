...
public class CoordinateFactory {
    ...
    public Coordinates getRandomCoordinates(){
        return new FactoryCoordinates(getRandom(globalEngine.getEngineSettings().getGlobalMapWidth(), GlobalEngine.getGlobalEngine().getEngineSettings().getRestrictedLine()),
                                      getRandom(globalEngine.getEngineSettings().getGlobalMapHeight(), GlobalEngine.getGlobalEngine().getEngineSettings().getRestrictedLine()));
    }
}
