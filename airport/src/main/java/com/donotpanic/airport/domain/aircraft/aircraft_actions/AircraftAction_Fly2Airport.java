...
public class AircraftAction_Fly2Airport extends AircraftAction {
    ...
    protected boolean checkEndOfAction(Plane plane) {
        return Actions.RADIOTOWER_REQUEST.getDurationSec()*0.5*plane.getSpeed() >= GeoLocationService.calculateDistance(plane.getDestinationTo(), getEngine().getObjectCoordinates(plane));
    }
